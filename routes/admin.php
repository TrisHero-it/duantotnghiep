...
use App\Http\Controllers\LichSuNapController;
...
Route::controller(CommentController::class)->group(function () {
    ...
    Route::post('comment/updateStatus',  'updateStatus')->name('admin.comment.updateStatus');
});
...
Route::controller(LichSuNapController::class)->as('admin.')->group(function () {
    Route::get('/lichsunaps', 'index')->name('lichsunaps.index');
});
